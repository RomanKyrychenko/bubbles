  ...
  df <- reactive({
    ...
    bubble <- function(data){
      ...
      p <- ggplot()+
        ...
        geom_text(aes(y=-5.3,min(as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-30"))+ifelse(input$typ!="Президент",2.35,1.85),label=format(parse_number(unname(unlist(data[18,4]))),big.mark=" ")),family="PT Sans", fontface = "bold",color="#a31e22",size=6)+
        geom_text(aes(y=-5.5,min(as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-30"))+ifelse(input$typ!="Президент",2.35,1.85),label=format(parse_number(unname(unlist(data[19,4]))),big.mark=" ")),family="PT Sans", fontface = "bold",color="#a31e22",size=6)+
        geom_text(aes(y=-5.7,min(as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-30"))+ifelse(input$typ!="Президент",2.35,1.85),label=format(parse_number(unname(unlist(data[20,4]))),big.mark=" ")),family="PT Sans", fontface = "bold",color="white",size=6)+
        geom_text(aes(y=-5.3,min(as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-30"))+ifelse(input$typ!="Президент",1.85,1.35),label=format(parse_number(unname(unlist(data[18,5]))),big.mark=" ")),family="PT Sans", fontface = "bold",color="#303d7d",size=6)+
        geom_text(aes(y=-5.5,min(as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-30"))+ifelse(input$typ!="Президент",1.85,1.35),label=format(parse_number(unname(unlist(data[19,5]))),big.mark=" ")),family="PT Sans", fontface = "bold",color="#303d7d",size=6)+
        geom_text(aes(y=-5.7,min(as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-30"))+ifelse(input$typ!="Президент",1.85,1.35),label=format(parse_number(unname(unlist(data[20,5]))),big.mark=" ")),family="PT Sans", fontface = "bold",color="white",size=6)+
