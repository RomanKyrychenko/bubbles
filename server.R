  ...
  df <- reactive({
    ...
    bubble <- function(data){
      ...
      p <- ggplot()+
        ...
        {if(sum(is.na(ifelse(!is.na(abs(parse_number(unname(unlist(data[4,2:8]))))),as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-23"),NA)))!=7)geom_segment(
            aes(
        ...
        {if(sum(is.na(ifelse(!is.na(abs(parse_number(unname(unlist(data[10,2:8]))))),as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-23"),NA)))!=7)geom_segment(
          aes(
        ...
        {if(sum(is.na(ifelse(!is.na(abs(parse_number(unname(unlist(data[12,2:8]))))),as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-23"),NA)))!=7)geom_segment(
          aes(
        ...
        geom_text(aes(y=-5.3,min(as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-23"))+0.25,label=format(parse_number(unname(unlist(data[18,2]))),big.mark=" ")),family="PT Sans", fontface = "bold",color="#303d7d",size=6)+
        geom_text(aes(y=-5.5,min(as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-23"))+0.25,label=format(parse_number(unname(unlist(data[19,2]))),big.mark=" ")),family="PT Sans", fontface = "bold",color="#303d7d",size=6)+
        geom_text(aes(y=-5.7,min(as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-23"))+0.25,label=format(parse_number(unname(unlist(data[20,2]))),big.mark=" ")),family="PT Sans", fontface = "bold",color="white",size=6)+
        geom_text(aes(y=-5.3,min(as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-23"))+0.75,label=format(parse_number(unname(unlist(data[18,3]))),big.mark=" ")),family="PT Sans", fontface = "bold",color="#a31e22",size=6)+
        geom_text(aes(y=-5.5,min(as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-23"))+0.75,label=format(parse_number(unname(unlist(data[19,3]))),big.mark=" ")),family="PT Sans", fontface = "bold",color="#a31e22",size=6)+
        geom_text(aes(y=-5.7,min(as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-23"))+0.75,label=format(parse_number(unname(unlist(data[20,3]))),big.mark=" ")),family="PT Sans", fontface = "bold",color="white",size=6)+
        geom_text(aes(y=-5.1,as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-23")[1]+0.25,label="Нейтрально"),family="PT Sans", fontface = "bold",color="#303d7d",size=6)+
        geom_text(aes(y=-5.1,as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-23")[1]+0.75,label="Негативно"),family="PT Sans", fontface = "bold",color="#a31e22",size=6)+
        geom_text(aes(y=-5.3,as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-23")[1]-0.32,label="TV"),family="PT Sans", fontface = "bold",color="#303d7d",hjust=0,size=6)+
        ...
        annotation_custom(rasterGrob(readPNG("2.png"), interpolate=TRUE), xmin=as.numeric(as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-23")[1])-0.7, xmax=as.numeric(as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-23")[1])-0.55, ymin=-2.6, ymax=-2.4)+
        annotation_custom(g, xmin=as.numeric(as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-23")[1])+1.25, xmax=as.numeric(as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-23")[1])+1.15, ymin=-5.4, ymax=-5.25)+
        annotation_custom(g, xmin=as.numeric(as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-23")[1])-0.45, xmax=as.numeric(as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-23")[1])-0.35, ymin=-5.4, ymax=-5.25)+
        annotation_custom(rasterGrob(readPNG("2.png"), interpolate=TRUE), xmin=as.numeric(as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-23")[1])+1.25, xmax=as.numeric(as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-23")[1])+1.15, ymin=-5.6, ymax=-5.45)+
        annotation_custom(rasterGrob(readPNG("2.png"), interpolate=TRUE), xmin=as.numeric(as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-23")[1])-0.45, xmax=as.numeric(as.Date(parse_number(unname(unlist(data[1,2:8]))),origin = "1899-12-23")[1])-0.35, ymin=-5.6, ymax=-5.45)+
